...
type GetCaptchaService interface {
	MicroGetCaptcha(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
}
...
func (c *getCaptchaService) MicroGetCaptcha(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "GetCaptcha.MicroGetCaptcha", in)
	out := new(Response)
...
type GetCaptchaHandler interface {
	MicroGetCaptcha(context.Context, *Request, *Response) error
}
...
func RegisterGetCaptchaHandler(s server.Server, hdlr GetCaptchaHandler, opts ...server.HandlerOption) error {
	type getCaptcha interface {
		MicroGetCaptcha(ctx context.Context, in *Request, out *Response) error
	}
...
func (h *getCaptchaHandler) MicroGetCaptcha(ctx context.Context, in *Request, out *Response) error {
	return h.GetCaptchaHandler.MicroGetCaptcha(ctx, in, out)
}
